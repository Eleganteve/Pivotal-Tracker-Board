...
def index():
    ...
    '''
    title = 'Home - Welcome to The Best parcel delivery Worldwide You Think of It We help share It.'
    blog = Blog.query.filter_by(category='Personal_delivery')
    blogone = Blog.query.filter_by(category='Institutional delivery')
...
def subscriber():
    ...
    if subscriber_form.validate_on_submit():
        ...
        db.session.commit()
        mail_message("Hey Welcome To parcel deliver ","email/welcome_subscriber",subscriber.email,subscriber=subscriber)
        subscriber = Blog.query.all()
        blog = Blog.query.all()
    return render_template('subscribe.html',subscriber=subscriber)
